...
<div align="center"><img width="280" alt="ChowDown Cafe Logo" src="https://github.com/user-attachments/assets/f6048073-162c-4aee-8848-6cb1f312fdbe" />
☕ ChowDown Café
...
https://img.shields.io/badge/Kotlin-1.9.x-7F52FF?style=for-the-badge&logo=kotlin
https://img.shields.io/badge/MySQL-8.x-4479A1?style=for-the-badge&logo=mysql
https://img.shields.io/badge/Firebase-Firestore-FFCA28?style=for-the-badge&logo=firebase
https://img.shields.io/badge/DevOps-GitHub%2520Actions-2088FF?style=for-the-badge&logo=github-actions
https://img.shields.io/badge/Docker-Containerized-2496ED?style=for-the-badge&logo=docker
...
📋 Table of Contents
<details> <summary><b>📑 Click to expand Table of Contents</b></summary>
📖 Project Overview
...
• Automated report generation	• Onboarding flow
• Browse promotions & menu
• Pickup order creation
• Real-time order tracking
• Push notifications
• Profile & settings management	MySQL (XAMPP)
• admins, staff, products
• orders, marketing_posts
...
Supplier Details
<img width="400" alt="Supplier Details" src="https://github.com/user-attachments/assets/9e8603f6-c0e9-4325-8a76-9e84eab78f29" />
</div>
...
Confirmation	Order Tracking	Settings
<img width="200" alt="Confirmation" src="https://github.com/user-attachments/assets/f57d8a8c-28bb-414b-b612-94364e5bbbd5" />	<img width="200" alt="Order Tracking" src="https://github.com/user-attachments/assets/f192b80e-54dd-4e10-a623-1493d118e251" />	<img width="200" alt="Settings" src="https://github.com/user-attachments/assets/5706bd78-dcd7-4056-859d-bd01ee32bd7c" />
</div>
👥 Team Members
...
Create database chowdown_db and import database/schema.sql
...
Move the repository to your server root (e.g., htdocs/chowdown-cafe)

Navigate to http://localhost/chowdown-cafe/admin-panel/

Run Mobile App:

Open /mobile-app in Android Studio

Link your google-services.json file for Firebase

Build and run on an Android Virtual Device (AVD)
...
📄 License & References
Developed for the Work Integrated Learning (WIL) program at Rosebank College.
...
Oracle Documentation. (2019). Available at: https://docs.oracle.com/en/database

<div align="center">
© 2026 Team Amajongo — Rosebank College WIL Project
Made with ❤️ by Team Amajongo
